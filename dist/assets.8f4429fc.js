...
MediaPlayer.prototype._initPlugins = function () {
  const player = {
    ...
    set muted(value) {
      this.media.muted = value; // if(value === true){
...
class Autopause {
  constructor() {
    this.threshold = 0.25; //se hace permanente el this a la instancia del objeto
  ...
  handleIntersection(entries) {
    const entry = entries[0]; //console.log(entry);
...
const player = new _MediaPlayer.default({
  el: video,
  plugins: [new _Autoplay.default(), new _Autoplay.default()]
});
...
},{"./MediaPlayer.js":"assets/MediaPlayer.js","./plugins/Autoplay.js":"assets/plugins/Autoplay.js","./plugins/AutoPause.js":"assets/plugins/AutoPause.js","C:\\Progra\\Profesional_JS\\sw.js":[["sw.js","sw.js"],"sw.js.map","sw.js"]}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
